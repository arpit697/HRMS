...
import { PATTERN_ERRORS } from "../../constant/errors";
// import { VALIDATION_MESSAGES, toTitleCase } from '../../constant/messages';
import { toTitleCase, VALIDATION_MESSAGES } from "../../constant/messages";
...
export class ValidationErrorPipe implements PipeTransform {
  ...
  getValidationError(control: FormControl, name) {
    ...
    if (control.hasError("min")) {
      return `${toTitleCase(name)} must be at least ${control.errors.min.min} `;
    }
