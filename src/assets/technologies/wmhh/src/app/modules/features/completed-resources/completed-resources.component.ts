...
@Component({
  selector: "app-completed-resources",
  templateUrl: "./completed-resources.component.html",
  styleUrls: ["./completed-resources.component.scss"],
})
export class CompletedResourcesComponent implements OnInit {
