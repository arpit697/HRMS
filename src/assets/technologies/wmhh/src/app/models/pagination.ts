...
import { FormUtils } from "../constant/form.util";
import { PAGE_START, PROPERTY_PAGINATION } from "../constant/app-constant";
// import { FormUtils } from 'src/app/modules/shared/utils/form.utils';
...
export class Pagination {
  ...
  constructor() {
    ...
    this.limit = PROPERTY_PAGINATION;
  ...
  get validPageOptions() {
    ...
    return { mainOption, filters: FormUtils.parse(this.filterOptions) };
  }
